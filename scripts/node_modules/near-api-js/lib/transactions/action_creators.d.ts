...
import { AccessKey, Action } from './actions.js';
 ...
 */
declare function stake(stake: bigint | undefined, publicKey: PublicKey): Action;
/**
 ...
 */
declare function addFullAccessKey(publicKey: PublicKey): Action;
 ...
 */
declare function addFunctionCallAccessKey(publicKey: PublicKey, receiverId: string, methodNames: string[], allowance?: bigint): Action;
/**
...
export declare const actions: {
    addFullAccessKey: typeof addFullAccessKey;
    addFunctionCallAccessKey: typeof addFunctionCallAccessKey;
